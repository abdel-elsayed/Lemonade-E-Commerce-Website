...
if(isset($_GET['add_cart'])){
	if( !in_array($_GET['item_id'], $_SESSION['cart_id'])){
		...
		header("Location:bags.php?addedSuccessfully");
		}
	}
...
if(isset($_GET['like'])){
	...
	header("Location:bags.php?likedSuccessfully");
...
if(isset($_GET['unlike'])){	
	...
	header("Location:bags.php?UnlikedSuccessfully");
...
<head>
	<title></title >
	<link rel="stylesheet" type= "text/css" href="/project/css/bags.css">
		...
		<div class="box">
			<div class="detailBox">
				...
				<?php
					...
					?> 
					<a href="bags.php?like=1&item_id=<?php echo $rows[$i]['item_id']?>" ><i class='fa fa-heart fa-lg' style='color:  white'></i></a>
					<?php 
					}elseif(in_array($rows[$i]['item_id'],$_SESSION['liked_items'])) {
					?>
					<a href="bags.php?unlike=1&item_id=<?php echo $rows[$i]['item_id']?>" ><i class='fa fa-heart fa-lg' style='color: #DC143C'></i></a>
					<?php } ?>	
            ...
            ?> 
            <a href="bags.php?add_cart=1&item_id=<?php echo $rows[$i]['item_id']?>" class="icon"><i class='fa fa-cart-plus fa-2x' style="color: #3498DB"></i></a>
            <?php 
            }else {
            ?>
